...
def acceleration(moon_position, spaceship_position):
    moon_spaceship_position = moon_position-spaceship_position
    earth_spaceship_position = -spaceship_position
    acc_vec = gravitational_constant*(earth_mass/numpy.linalg.norm(earth_spaceship_position)** 3 * earth_spaceship_position + 
                                      moon_mass/numpy.linalg.norm(moon_spaceship_position)** 3 * moon_spaceship_position)
    return acc_vec
